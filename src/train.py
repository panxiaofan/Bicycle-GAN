...
def loss_generator(G, real_img, z, target_img):
    '''
    Input:
    G - generator
...
def loss_discriminator(fake_img, D, real_img, valid, fake):
    '''
    ...
    real_d_out_1,  real_d_out_2= D.forward(real_img)

    real_loss_1 = criterion(real_d_out_1, valid)
    real_loss_2 = criterion(real_d_out_2, valid)

    fake_d_out_1, fake_d_out_2 = D.forward(fake_img)

    fake_loss_1 = criterion(fake_d_out_1, fake)
    fake_loss_2 = criterion(fake_d_out_2, fake)
...
def z_loss(fake_img, encoder, random_z):
    '''
    Input:
